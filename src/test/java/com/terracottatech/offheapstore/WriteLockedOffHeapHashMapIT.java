...
public class WriteLockedOffHeapHashMapIT extends AbstractConcurrentOffHeapMapIT {
  ...
  protected ConcurrentMap<SpecialInteger, SpecialInteger> createGoodMap() {
    return new WriteLockedOffHeapHashMap<SpecialInteger, SpecialInteger>(new UnlimitedPageSource(new OffHeapBufferSource()), Generator.GOOD_ENGINE, 1);
  }

  @Override
  protected ConcurrentMap<SpecialInteger, SpecialInteger> createBadMap() {
    return new WriteLockedOffHeapHashMap<SpecialInteger, SpecialInteger>(new UnlimitedPageSource(new OffHeapBufferSource()), Generator.BAD_ENGINE, 1);
  }
