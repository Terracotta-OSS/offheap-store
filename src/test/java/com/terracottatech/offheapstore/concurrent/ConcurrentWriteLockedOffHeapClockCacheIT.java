...
public class ConcurrentWriteLockedOffHeapClockCacheIT extends AbstractConcurrentOffHeapMapIT {
  ...
  protected ConcurrentMap<SpecialInteger, SpecialInteger> createGoodMap() {
    return new ConcurrentWriteLockedOffHeapClockCache<SpecialInteger, SpecialInteger>(new UnlimitedPageSource(new OffHeapBufferSource()), Generator.GOOD_FACTORY, 1, 16);
  }

  @Override
  protected ConcurrentMap<SpecialInteger, SpecialInteger> createBadMap() {
    return new ConcurrentWriteLockedOffHeapClockCache<SpecialInteger, SpecialInteger>(new UnlimitedPageSource(new OffHeapBufferSource()), Generator.BAD_FACTORY, 1, 16);
  }
