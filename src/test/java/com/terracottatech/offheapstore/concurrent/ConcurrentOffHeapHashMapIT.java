...
public class ConcurrentOffHeapHashMapIT extends AbstractConcurrentOffHeapMapIT {
  ...
  protected ConcurrentMap<SpecialInteger, SpecialInteger> createGoodMap() {
    return new ConcurrentOffHeapHashMap<SpecialInteger, SpecialInteger>(new UnlimitedPageSource(new OffHeapBufferSource()), Generator.GOOD_FACTORY, 1, 16);
  }

  @Override
  protected ConcurrentMap<SpecialInteger, SpecialInteger> createBadMap() {
    return new ConcurrentOffHeapHashMap<SpecialInteger, SpecialInteger>(new UnlimitedPageSource(new OffHeapBufferSource()), Generator.BAD_FACTORY, 1, 16);
  }
