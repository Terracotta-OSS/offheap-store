...
public class MinimalConcurrentCacheRestartabilityIT extends AbstractRestartabilityCacheIT {
  ...
  protected <K, V> Map<K, V> createRestartableMap(long size, MemoryUnit unit, ByteBuffer id,
    ...
    Factory<? extends StorageEngine<K, V>> storageEngineFactory = RestartableMinimalStorageEngine.createMinimalFactory(id, persistence, synchronous, getPointerSize(), source, MemoryUnit.KILOBYTES.toBytes(1), keyPortability, valuePortability, false, false, 0.75f);
